 ...
 */
final class Version20220502225946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE plat (id INT NOT NULL, personne_id INT DEFAULT NULL, categorie_plat_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, prix INT NOT NULL, description VARCHAR(255) DEFAULT NULL, categorie VARCHAR(255) NOT NULL, statut TINYINT(1) NOT NULL, INDEX IDX_2038A207A21BD112 (personne_id), INDEX IDX_2038A20788BE1BC2 (categorie_plat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE categorie ADD CONSTRAINT FK_497DD634BF396750 FOREIGN KEY (id) REFERENCES actions_infos (id) ON DELETE CASCADE');
