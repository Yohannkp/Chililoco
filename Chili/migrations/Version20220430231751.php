 ...
 */
final class Version20220430231751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plat CHANGE id id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plat CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
}
